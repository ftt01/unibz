...
output_log = output_path + 'passirio_precipitation_lapse_rate_reanalysis11x8.log'
...
output_file_hd = output_path + 'meteo_passirio_precipitation_rea11_over_elevation_hd.' + output_format
