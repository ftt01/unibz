...
createBoxPlot( temperature_bias_monthly_sum,  "Time $[month]$", "Temp. bias $[\degree C]$",     output_path, label="(b)", period='MS', scale_factor=0.5, output_format=output_format, my_dpi=50 )
...
createBoxPlot( temperature_bias_monthly_sum,  "Time $[month]$", "Temp. bias $[\degree C]$",     output_path_hd, label="(b)", period='MS', scale_factor=0.5, output_format=output_format, my_dpi=600)
