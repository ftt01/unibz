...
output_path = current.config["output_path"] + "model/streamflow/passirio/monthly/"     + "model_streamflow_passirio_merano_boxplotBias_rea-kr11." + output_format
...
output_path_hd = current.config["output_path"] + "model/streamflow/passirio/monthly/"     + "model_streamflow_passirio_merano_boxplotBias_rea-kr11_HD." + output_format
