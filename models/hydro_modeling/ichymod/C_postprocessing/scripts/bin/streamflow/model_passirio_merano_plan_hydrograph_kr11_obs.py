...
plots.append( (kriging_11_data_calibration.obs_flow, plt_conf) )

### kriging 1x1 plot ###
plt_conf = {}
plt_conf["label"] = 'Kriging 11x8'
plt_conf["color"] = '#5e3c99'
plots.append( (kriging_11_data_calibration.model_flow, plt_conf) )

import matplotlib.dates as mdates
x_major_locator=mdates.YearLocator(month=10, day=1)
x_major_formatter=mdates.DateFormatter('%Y-%m')

outfile_hd = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_plan/"     + "model_streamflow_passirio_merano_plan_hourly_hydrograph_kr11_obs_calibration_hd." + output_format
...
outfile = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_plan/"     + "model_streamflow_passirio_merano_plan_hourly_hydrograph_kr11_obs_calibration." + output_format
...
plt_conf["label"] = 'Observed'
plt_conf["color"] = '#fdb863'
plots.append( (kriging_11_data_validation.obs_flow, plt_conf) )

### kriging 1x1 plot ###
plt_conf = {}
plt_conf["label"] = 'Kriging 11x8'
plt_conf["color"] = '#5e3c99'
plots.append( (kriging_11_data_validation.model_flow, plt_conf) )

import matplotlib.dates as mdates
x_major_locator=mdates.YearLocator(month=10, day=1)
x_major_formatter=mdates.DateFormatter('%Y-%m')

outfile_hd = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_plan/"     + "model_streamflow_passirio_merano_plan_hourly_hydrograph_kr11_obs_validation_hd." + output_format
...
outfile = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_plan/"     + "model_streamflow_passirio_merano_plan_hourly_hydrograph_kr11_obs_validation." + output_format
...
plt_conf["label"] = 'Observed'
plt_conf["color"] = '#fdb863'
plots.append( (kriging_11_data_validation.obs_flow[start_date:end_date], plt_conf) )

### kriging 11x8 plot ###
plt_conf = {}
plt_conf["label"] = 'Kriging 11x8'
plt_conf["color"] = '#5e3c99'
plots.append( (kriging_11_data_validation.model_flow[start_date:end_date], plt_conf) )
