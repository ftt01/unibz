...
kr_rea_output_file = current.config["output_path"] + "model/streamflow/passirio/daily/" + "model_streamflow_passirio_merano_daily_ECDF_kr_rea_kr11_obs_insected." + output_format
createPlot(plots,  "Streamflow $[m^3/day]$", "ECDF",
           kr_rea_output_file, output_format=output_format, my_dpi=50)

kr_rea_output_file_log = current.config["output_path"] + "model/streamflow/passirio/daily/" + "model_streamflow_passirio_merano_daily_ECDF_kr_rea_kr11_obs_log_insected." + output_format
createPlot(plots,  "Streamflow $[m^3/day]$", "ECDF",
           kr_rea_output_file_log, output_format=output_format, xscale='log', my_dpi=50)

kr_rea_output_file_hd = current.config["output_path"] +"model/streamflow/passirio/daily/" + "model_streamflow_passirio_merano_daily_ECDF_kr_rea_kr11_obs_HD_insected." + output_format
createPlot(plots,  "Streamflow $[m^3/day]$", "ECDF",
           kr_rea_output_file_hd, output_format=output_format, my_dpi=600)

kr_rea_output_file_log_hd = current.config["output_path"] + "model/streamflow/passirio/daily/" + "model_streamflow_passirio_merano_daily_ECDF_kr_rea_kr11_obs_HD_log_insected." + output_format
createPlot(plots,  "Streamflow $[m^3/day]$", "ECDF",
