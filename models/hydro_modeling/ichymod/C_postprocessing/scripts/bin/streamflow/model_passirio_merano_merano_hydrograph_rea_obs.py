...
obs_data = pd.concat( [reanalysis_data_calibration.obs_flow, reanalysis_data_validation.obs_flow] )
...
last_date_cal = reanalysis_data_calibration.model_flow.index[-1]
first_date_val = reanalysis_data_validation.model_flow.index[0]

max_h = max( np.concatenate((reanalysis_data_calibration.model_flow.values, reanalysis_data_validation.model_flow.values,     reanalysis_data_calibration.obs_flow.values, reanalysis_data_validation.obs_flow.values)) )
...
plots.append( (reanalysis_data, plt_conf) )
...
outfile_hd = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/"     + "model_streamflow_passirio_merano_hourly_hydrograph_rea_obs_hd." + output_format
...
outfile = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/"     + "model_streamflow_passirio_merano_hourly_hydrograph_rea_obs." + output_format
...
plt_conf["label"] = 'Reanalysis 11x8'
plt_conf["color"] = '#e66101'
plots.append( (reanalysis_data[start_date:end_date], plt_conf) )
