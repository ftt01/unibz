...
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/h]$", outfile_hd, label="(a)",
...
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/h]$", outfile, label="(a)",
...
createPlot( plots, "Exceedance Probability", "Streamflow $[m^3/hour]$", outfile, loc="lower left", yscale='log', height=80, my_dpi=50 )
...
print("Kriging 1x1 NASH from " + start_date_str + " to " + end_date_str + ": " + str(kriging_nash))

kriging_11_nash = evaluateNash( obs_data[start_date:end_date], kriging_11_data[start_date:end_date], round_el=2 )
print("Kriging 11x8 NASH from " + start_date_str + " to " + end_date_str + ": " + str(kriging_11_nash))

rea_nash = evaluateNash( obs_data[start_date:end_date], rea_data[start_date:end_date], round_el=2 )
print("Reanalysis 11x8 NASH from " + start_date_str + " to " + end_date_str + ": " + str(rea_nash))
...
# ## NASH evaluation
# kriging_nash_w = evaluateNash( obs_data_w, kriging_data_w, round_el=2 )
# print("Kriging 1x1 winter NASH from " + start_date_str + " to " + end_date_str + ": " + str(kriging_nash_w))
# kriging_nash_sp = evaluateNash( obs_data_sp, kriging_data_sp, round_el=2 )
# print("Kriging 1x1 spring NASH from " + start_date_str + " to " + end_date_str + ": " + str(kriging_nash_sp))
# kriging_nash_su = evaluateNash( obs_data_su, kriging_data_su, round_el=2 )
# print("Kriging 1x1 summer NASH from " + start_date_str + " to " + end_date_str + ": " + str(kriging_nash_su))
# kriging_nash_a = evaluateNash( obs_data_a, kriging_data_a, round_el=2 )
# print("Kriging 1x1 autumns NASH from " + start_date_str + " to " + end_date_str + ": " + str(kriging_nash_a))

# kriging_11_nash_w = evaluateNash( obs_data_w, kriging_11_data_w, round_el=2 )
# print("Kriging 11x8 winter NASH from " + start_date_str + " to " + end_date_str + ": " + str(kriging_11_nash_w))
# kriging_11_nash_sp = evaluateNash( obs_data_sp, kriging_11_data_sp, round_el=2 )
# print("Kriging 11x8 spring NASH from " + start_date_str + " to " + end_date_str + ": " + str(kriging_11_nash_sp))
# kriging_11_nash_su = evaluateNash( obs_data_su, kriging_11_data_su, round_el=2 )
# print("Kriging 11x8 summer NASH from " + start_date_str + " to " + end_date_str + ": " + str(kriging_11_nash_su))
# kriging_11_nash_a = evaluateNash( obs_data_a, kriging_11_data_a, round_el=2 )
# print("Kriging 11x8 autumns NASH from " + start_date_str + " to " + end_date_str + ": " + str(kriging_11_nash_a))

# rea_nash_w = evaluateNash( obs_data_w, rea_data_w, round_el=2 )
# print("Reanalysis 11x8 winter NASH from " + start_date_str + " to " + end_date_str + ": " + str(rea_nash_w))
# rea_nash_sp = evaluateNash( obs_data_sp, rea_data_sp, round_el=2 )
# print("Reanalysis 11x8 spring NASH from " + start_date_str + " to " + end_date_str + ": " + str(rea_nash_sp))
# rea_nash_su = evaluateNash( obs_data_su, rea_data_su, round_el=2 )
# print("Reanalysis 11x8 summer NASH from " + start_date_str + " to " + end_date_str + ": " + str(rea_nash_su))
# rea_nash_a = evaluateNash( obs_data_a, rea_data_a, round_el=2 )
# print("Reanalysis 11x8 autumns NASH from " + start_date_str + " to " + end_date_str + ": " + str(rea_nash_a))
