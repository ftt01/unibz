...
outfile_hd = current.config["output_path"] + "model/streamflow/passirio/hourly/plan_plan/"     + "model_streamflow_passirio_plan_plan_hourly_hydrograph_rea_obs_hd." + output_format
...
outfile = current.config["output_path"] + "model/streamflow/passirio/hourly/plan_plan/"     + "model_streamflow_passirio_plan_plan_hourly_hydrograph_rea_obs." + output_format
