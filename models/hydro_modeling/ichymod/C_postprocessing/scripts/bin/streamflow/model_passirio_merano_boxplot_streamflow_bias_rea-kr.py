...
data_monthly_mean = data_rea_temporal_mean - data_kr_temporal_mean


# In[ ]:


output_path = current.config["output_path"] + "model/streamflow/passirio/monthly/"     + "model_streamflow_passirio_merano_boxplotBias_rea-kr." + output_format
...
output_path_hd = current.config["output_path"] + "model/streamflow/passirio/monthly/"     + "model_streamflow_passirio_merano_boxplotBias_rea-kr_hd." + output_format
