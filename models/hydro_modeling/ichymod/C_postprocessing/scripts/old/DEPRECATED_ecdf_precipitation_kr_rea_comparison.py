...
# ######################################################################################################
# ## model precipitation ECDF - kriging ################################################################
# plots = []
...
# ecdf_model_precipitation_daily_mean = evaluateECDF( model_precipitation.resample('D').mean() )

# plt_conf = {}
# plt_conf["label"] = "Kriging 1x1"
# plots.append( (ecdf_model_precipitation_daily_mean, plt_conf) )

# ## model precipitation ECDF - reanalysis ##
# ### simulation selection #############################################################################
...
# ecdf_model_precipitation_daily_mean = evaluateECDF(
#     model_precipitation.resample('D').mean())
