...
data_daily_mean = data_kr11_daily_mean - data_rea_daily_mean

#######################################################################################################
output_path = config["output_path"] + "model\\passirio\\streamflow\\monthly\\" \
    + "model_passirio_merano_boxplot_streamflow_bias_kr11-rea." + output_format 
...
output_path_hd = config["output_path"] + "model\\passirio\\streamflow\\monthly\\" \
    + "model_passirio_merano_boxplot_streamflow_bias_kr11-rea_hd." + output_format 
