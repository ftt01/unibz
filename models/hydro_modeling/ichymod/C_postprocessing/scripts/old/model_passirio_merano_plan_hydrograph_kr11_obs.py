...
#     + "model_passirio_merano_plan_hydrograph_kr11_obs." + output_format
...
#     + "model_passirio_merano_plan_hydrograph_kr11_obs_hd." + output_format
...
# plt_conf = {}
# plt_conf["label"] = 'Kriging 11x8'
# plots.append( (model_flow_kriging_11_calibration, plt_conf) )
...
# outfile = config["output_path"] + "model\\passirio\\streamflow\\hourly\\merano_plan\\" \
#     + "model_passirio_merano_plan_hydrograph_kr11_obs_calibration." + output_format
...
# outfile_hd = config["output_path"] + "model\\passirio\\streamflow\\hourly\\merano_plan\\" \
#     + "model_passirio_merano_plan_hydrograph_kr11_obs_calibration_hd." + output_format
...
plt_conf = {}
#plt_conf["label"] = 'Kriging 11x8'
plots.append( (model_flow_kriging_11_validation, plt_conf) )
...
outfile = config["output_path"] + "model\\passirio\\streamflow\\hourly\\merano_plan\\" \
    + "model_passirio_merano_plan_hydrograph_kr11_obs_validation." + output_format
createPlot( plots, "Time $[hour]$", "Streamflow $[m^3/hour]$", outfile, width=150, height=80, \
    x_major_locator=x_major_locator, x_major_formatter=x_major_formatter, my_dpi=50 )

outfile_hd = config["output_path"] + "model\\passirio\\streamflow\\hourly\\merano_plan\\" \
    + "model_passirio_merano_plan_hydrograph_kr11_obs_validation_hd." + output_format
