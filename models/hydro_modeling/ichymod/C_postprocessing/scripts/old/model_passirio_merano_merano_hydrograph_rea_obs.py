...
outfile_hd = config["output_path"] + "model\\passirio\\streamflow\\hourly\\merano_merano\\" \
    + "model_passirio_merano_merano_hydrograph_rea_obs_hd." + output_format
...
outfile = config["output_path"] + "model\\passirio\\streamflow\\hourly\\merano_merano\\" \
    + "model_passirio_merano_merano_hydrograph_rea_obs." + output_format
...
plt_conf = {}
plt_conf["label"] = 'Reanalysis 11x8'
plots.append( (calibration_validation_data_reanalysis[start_date:end_date], plt_conf) )
...
outfile_hd = config["output_path"] + "model\\passirio\\streamflow\\hourly\\merano_merano\\" \
    + "model_passirio_merano_merano_hydrograph_rea_obs_20152016_hd." + output_format
createPlot( plots, "Time $[hour]$", "Streamflow $[m^3/hour]$", outfile_hd, \
    x_major_locator=x_major_locator, x_major_formatter=x_major_formatter, my_dpi=600, height=80 )

outfile = config["output_path"] + "model\\passirio\\streamflow\\hourly\\merano_merano\\" \
    + "model_passirio_merano_merano_hydrograph_rea_20152016_obs." + output_format
createPlot( plots, "Time $[hour]$", "Streamflow $[m^3/hour]$", outfile, \
    x_major_locator=x_major_locator, x_major_formatter=x_major_formatter, my_dpi=50, height=80 )
...
outfile_hd = config["output_path"] + "model\\passirio\\streamflow\\hourly\\merano_merano\\" \
    + "model_passirio_merano_merano_hydrograph_rea_obs_20162017_hd." + output_format
createPlot( plots, "Time $[hour]$", "Streamflow $[m^3/hour]$", outfile_hd, \
    x_major_locator=x_major_locator, x_major_formatter=x_major_formatter, my_dpi=600, height=80 )

outfile = config["output_path"] + "model\\passirio\\streamflow\\hourly\\merano_merano\\" \
    + "model_passirio_merano_merano_hydrograph_rea_20162017_obs." + output_format
createPlot( plots, "Time $[hour]$", "Streamflow $[m^3/hour]$", outfile, \
    x_major_locator=x_major_locator, x_major_formatter=x_major_formatter, my_dpi=50, height=80 )
