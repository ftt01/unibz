...
# configPath = "C:\\Users\\daniele\\Documents\\GitHub\\ftt01\\phd\\hydro_modeling\\ichymod\\C_postprocessing\\scripts\\etc\\conf\\"
configPath = "/home/daniele/documents/github/ftt01/phd/models/hydro_modeling/ichymod/C_postprocessing/scripts/etc/conf/"

###### SETUP PLOTS ###################################################################################

# plt.style.use('C:\\Users\\daniele\\Documents\\GitHub\\ftt01\\phd\\ITstuff\\python\\matplotlib\\template.mplstyle')
plt.style.use(
    "/home/daniele/documents/github/ftt01/phd/ITstuff/python/matplotlib/template.mplstyle")
...
class DataCollector():
    ...
    def __init__(self, configPath=configPath, config='config.json', sim_config='sim_config.json',
...
def createBoxPlot(df_in, x_label, y_label, output_file, label=None,
    ...
    if label != None:
        axs.text(0, 0, label, transform=fig.dpi_scale_trans, fontsize=label_size/scale_factor, va='bottom', ha='left')
...
def instantiatePlot(x_label, y_label,
                    output_format='tiff', xscale="linear", yscale="linear",
...
# def createPlotWithInset(x_label, y_label, output_format='tiff', xscale="linear", yscale="linear",
#                     width=190, height=90, scale_factor=1,
#                     tick_size=10, label_size=10, legend_fontsize=8,
