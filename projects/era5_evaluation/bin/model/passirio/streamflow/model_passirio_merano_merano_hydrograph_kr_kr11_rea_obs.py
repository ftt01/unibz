...
outfile_hd = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/" +     "model_streamflow_passirio_merano_hourly_hydrograph_kr_kr11_rea_obs_HD." + output_format
createPlot(plots, "Time $[hour]$", "Streamflow $[m^3/hour]$", outfile_hd, plot_legend=True,
           yticks=np.arange(0,451,25).tolist(), y_lim_min=0, y_lim_max=450,
           x_major_locator=x_major_locator, x_major_formatter=x_major_formatter, my_dpi=600, height=120)

outfile = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/" +     "model_streamflow_passirio_merano_hourly_hydrograph_kr_kr11_rea_obs." + output_format
createPlot(plots, "Time $[hour]$", "Streamflow $[m^3/hour]$", outfile,plot_legend=True,
           yticks=np.arange(0,451,25).tolist(), y_lim_min=0, y_lim_max=450,
           x_major_locator=x_major_locator, x_major_formatter=x_major_formatter, my_dpi=50, height=120)


### evaluate means

print("OBS: " + str(obs_data.describe()))
print("KR11x8: " + str(kriging_11_data.describe()))
print("KR1x1: " + str(kriging_data.describe()))
print("REA11x8: " + str(rea_data.describe()))
...
outfile_hd = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/" +     "model_streamflow_passirio_merano_hourly_hydrograph_kr_kr11_rea_obs_20152016_hd." + output_format
createPlot(plots, "Time $[hour]$", "Streamflow $[m^3/hour]$", outfile_hd,
           x_major_locator=x_major_locator, x_major_formatter=x_major_formatter, my_dpi=600, height=90)

outfile = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/" +     "model_streamflow_passirio_merano_hourly_hydrograph_kr_kr11_rea_20152016_obs." + output_format
createPlot(plots, "Time $[hour]$", "Streamflow $[m^3/hour]$", outfile,
           x_major_locator=x_major_locator, x_major_formatter=x_major_formatter, my_dpi=50, height=90)
...
outfile_hd = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_kr_kr11_rea_obs_hd." + output_format
createPlot(plots, "Exceedance Probability",
           "Streamflow $[m^3/hour]$", outfile_hd, yscale='log', height=90, width=90, my_dpi=600)

outfile = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_kr_kr11_rea_obs." + output_format
createPlot(plots, "Exceedance Probability",
           "Streamflow $[m^3/hour]$", outfile, yscale='log', height=90, width=90, my_dpi=50)


# In[14]:


np.sort(obs_data[start_date:end_date].dropna())[::-1]


# In[15]:


obs_data[start_date:end_date].dropna()


# In[16]:


# calibration exceedance curve evaluation
...
outfile_hd = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_kr_kr11_rea_obs_cal_hd." + output_format
createPlot(plots, "Exceedance Probability",
           "Streamflow $[m^3/hour]$", outfile_hd, xticks=[0,25,50,75,100], label='(a)', \
            yscale='log', width=90, height=90, my_dpi=600)

outfile = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_kr_kr11_rea_obs_cal." + output_format
createPlot(plots, "Exceedance Probability",
           "Streamflow $[m^3/hour]$", outfile, xticks=[0,25,50,75,100], label='(a)', \
           yscale='log', width=90, height=90, my_dpi=50)


# In[17]:


# validation exceedance curve evaluation
...
obs_data_cut = obs_data.copy()
obs_data_cut = obs_data_cut[start_date:end_date]
obs_data_cut[obs_data_cut<=1.8] = 2.5
...
outfile_hd = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_kr_kr11_rea_obs_val_hd." + output_format
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/hour]$", outfile_hd, \
           xticks=[0,25,50,75,100], label='(b)', plot_legend=True, \
           yscale='log', width=90, height=90, my_dpi=600)

outfile = current.config["output_path"] + "model/streamflow/passirio/hourly/merano_merano/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_kr_kr11_rea_obs_val." + output_format
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/hour]$", outfile, 
           xticks=[0,25,50,75,100], label='(b)', plot_legend=True, \
           yscale='log', width=90, height=90, my_dpi=50)
...
outfile_hd = current.config["output_path"] + "model/streamflow/passirio/seasonal/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_autumn_kr_kr11_rea_obs_hd." + output_format
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/h]$", outfile_hd, label="(a.1)", y_lim_min=0.2,
           y_lim_max=250, loc="lower left", scale_factor=1, yscale='log', height=60, width=90, my_dpi=600)

outfile = current.config["output_path"] + "model/streamflow/passirio/seasonal/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_autumn_kr_kr11_rea_obs." + output_format
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/h]$", outfile, label="(a.1)", y_lim_min=0.2,
           y_lim_max=250, loc="lower left", scale_factor=1, yscale='log', height=60, width=90, my_dpi=50)
...
outfile_hd = current.config["output_path"] + "model/streamflow/passirio/seasonal/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_winter_kr_kr11_rea_obs_hd." + output_format
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/h]$", outfile_hd, label="(a.2)", y_lim_min=0.03,
           y_lim_max=50, plot_legend=False, scale_factor=1, yscale='log', height=60, width=90, my_dpi=600)

outfile = current.config["output_path"] + "model/streamflow/passirio/seasonal/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_winter_kr_kr11_rea_obs." + output_format
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/h]$", outfile, label="(a.2)", y_lim_min=0.03,
...
outfile_hd = current.config["output_path"] + "model/streamflow/passirio/seasonal/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_spring_kr_kr11_rea_obs_hd." + output_format
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/h]$", outfile_hd, label="(a.3)",
           y_lim_min=0.02, y_lim_max=250, plot_legend=False, scale_factor=1, yscale='log',
           height=60, width=90, my_dpi=600)

outfile = current.config["output_path"] + "model/streamflow/passirio/seasonal/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_spring_kr_kr11_rea_obs." + output_format
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/h]$", outfile, label="(a.3)",
           y_lim_min=0.02, y_lim_max=250, plot_legend=False, scale_factor=1, yscale='log',
...
outfile_hd = current.config["output_path"] +     "model/streamflow/passirio/seasonal/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_summer_kr_kr11_rea_obs_hd." + output_format
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/h]$", outfile_hd, #label="(a.4)",
           y_lim_min=0.7, y_lim_max=250, plot_legend=False, scale_factor=1, yscale='log',
           height=60, width=90, my_dpi=600)

outfile = current.config["output_path"] + "model/streamflow/passirio/seasonal/" +     "model_streamflow_passirio_merano_hourly_exceedance_curve_summer_kr_kr11_rea_obs." + output_format
createPlot(plots, "Exceedance Probability", "Streamflow $[m^3/h]$", outfile, #label="(a.4)",
           y_lim_min=0.7, y_lim_max=250, plot_legend=False, scale_factor=1, yscale='log', 
            height=60, width=90, my_dpi=50)
